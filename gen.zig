...
pub fn ClearBackground (color: t.Color) void {var _color = color;
...
pub fn BeginMode2D (camera: t.Camera2D) void {var _camera = camera;
...
pub fn GetCameraMatrix2D (camera: t.Camera2D) t.Matrix {var _camera = camera;
...
pub fn GetWorldToScreen2D (position: t.Vector2, camera: t.Camera2D) t.Vector2 {var _position = position;
var _camera = camera;
...
pub fn GetScreenToWorld2D (position: t.Vector2, camera: t.Camera2D) t.Vector2 {var _position = position;
var _camera = camera;
var _out: t.Vector2 = undefined;
...
pub fn GetMousePosition () t.Vector2 {var _out: t.Vector2 = undefined;

    r.mGetMousePosition(
        @ptrCast([*c]r.Vector2, &_out),
    );    return _out;}

pub fn GetMouseDelta () t.Vector2 {var _out: t.Vector2 = undefined;
...
pub fn GetTouchPosition (index: i32) t.Vector2 {var _out: t.Vector2 = undefined;
...
pub fn DrawLineEx (startPos: t.Vector2, endPos: t.Vector2, thick: f32, color: t.Color) void {var _startPos = startPos;
var _endPos = endPos;
var _color = color;
...
pub fn DrawRectanglePro (rec: t.Rectangle, origin: t.Vector2, rotation: f32, color: t.Color) void {var _rec = rec;
var _origin = origin;
var _color = color;
...
pub fn UnloadTexture (texture: t.Texture2D) void {var _texture = texture;
...
pub fn DrawText (text: []const u8, posX: i32, posY: i32, fontSize: i32, color: t.Color) void {var _color = color;
